...
class TimelineVisualizer:
    ...
    def visualize(self, output_file=None):
        ...
        print("Iteration Time: {}ms".format(self._iteration_time))
    ...
    def _load_templates(self):
        ...
        self._main_template = _template_env.get_template("main.html")
    ...
    def get_data(self):
        ...
        for device in stats.dev_stats:
            ...
            if len(self._device_pattern_re.findall(device_name)) == 0:
                ...
                continue
            event = self._process_device(device_name,
                                         [node for node in device.node_stats],
                                         base_timestamp)
            events.append(event)
